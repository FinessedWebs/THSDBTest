...
if (isset($_GET['delete'])) {
  $id = $_GET['delete'];  // No need for intval since it's a string
  ...
  if ($stmt) {
    ...
    if ($stmt->affected_rows > 0) {
      ...
      echo "Deletion failed. MySQL Error: " . $stmt->error . "<br>";
    }

    $stmt->close();
  } else {
    echo "Failed to prepare statement. MySQL Error: " . $mysqli->error . "<br>";
  }
}
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>R <?php echo $prod->prod_price; ?></td>
                      <td>
