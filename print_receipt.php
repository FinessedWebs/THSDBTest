...
<head>
    ...
    <title>The Home Salon Point Of Sale </title>
    <!-- Favicon -->
...
while ($order = $res->fetch_object()) {
    ...
    $pay_method = $order->pay_method; // Retrieve the payment method
?>
                ...
                <div id="Receipt" class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <address>
                                <strong>The Home Salon</strong>
                                <br>
                                Custom Carpentry Contractors
                                <br>
                                thehomesalon1@gmail.com
                                <br>
                                (+27) 69 933 2085
                            </address>
                        </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="col-md-1 text-center">R<?php echo $order->prod_price; ?></td>
                                    <td class="col-md-1 text-center">R<?php echo $total; ?></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td></td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <p>
                                            <strong><?php echo $pay_method; ?></strong> <!-- Display payment method -->
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center text-danger">
                                        <h4><strong>R<?php echo $total; ?></strong></h4>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
